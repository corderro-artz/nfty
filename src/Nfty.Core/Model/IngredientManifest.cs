...
/// <summary>One layer, or trait-category: a kind, how it is coloured, and its weighted variants.</summary>
...
/// <param name="Kind">Whether the layer rolls a colour, applies one fixed colour, or is composited
/// as-is; see <see cref="LayerKind"/>.</param>
/// <param name="Colorization">How a Dynamic or Static layer is coloured. Must be null for
